...
import { BarcodeProduct, BarcodeLookupResult, lookupBarcode, scanBarcodeFromImage } from '../services/barcodeService';
...
const BarcodeScanner: React.FC<BarcodeScannerProps> = ({ onBarcodeDetected, onCancel }) => {
  ...
  const startScanning = async () => {
    ...
    try {
      ...
      reader.decodeFromVideoElement(videoRef.current!, (result: Result | undefined, err: any) => {
